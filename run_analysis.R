...
##With one exception and that is the duplicate errors, such as in "fBodyBodyAccJerkMag"
## lets replace where there is "BodyBody"" with just "Body" for all occurances.
